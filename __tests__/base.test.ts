...
describe("Twitter Client Base", () => {
  ...
  beforeEach(() => {
    mockRuntime = {
      env: {
        ...
        TWITTER_ENABLE_TIMELINE_ACTION_PROCESSING: "true",
    ...
    mockConfig = {
      ...
      ACTION_INTERVAL: 5,
      ENABLE_TIMELINE_ACTION_PROCESSING: true,
  ...
  it("should initialize with correct action settings", () => {
    ...
    expect(client.twitterConfig.ENABLE_TIMELINE_ACTION_PROCESSING).toBe(true);
  });
});
